...
$this->title = 'ตรวจสอบการให้ำรหัสหัตถการ rehab_code ผู้ป่วย OPD ซ้ำซ้อนเป็นรายบุคคล (กายภาพบำบัด)';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบ [COUNT(i.f43_rehab_code)>1 , GROUP BY pm.vn,pm.vstdate,i.f43_rehab_code] นับซ้ำรหัสหัตถการกายภาพ rehab_code ผู้ป่วย OPD ใน 1 Visit ของวันรับบริการเดียวกัน</font></p></h6>
    ...
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Rehabilitation_Detail3_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Rehabilitation_Detail3_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Rehabilitation_Detail3_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Rehabilitation_Detail3_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
