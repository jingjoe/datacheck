...
$this->title = 'ตรวจข้อมูลประวัติการแพ้ยาของผู้ป่วยที่มารับบริการ เป็นรายบุคคล (สถานพยาบาลแห่งนี้เป็นผู้พบการแพ้ยาเอง)';
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><?= Html::encode($this->title) ?> ข้อมูล ณ.วันที่ <?= Yii::$app->formatter->asDate('now', 'php:Y-m-d'); ?></h3>
                <h6><p><font color="red">เงื่อนไขการตรวจสอบข้อมูลประวัติการแพ้ยาของผู้ป่วยที่มารับบริการ แฟ้ม DRUGALLERGY(ประวัติการแพ้ยา,รหัสยาที่มีประวัติการแพ้)
                                         ผู้ให้ประวัติการแพ้ยา ประกอบด้วยกลุ่ม (4= สถานพยาบาลแห่งนี้เป็นผู้พบการแพ้ยาเอง)</font></p></h6>
...
<div class="box-body no-padding">
 <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Drugallergy_Detail1_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Drugallergy_Detail1_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Drugallergy_Detail1_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Drugallergy_Detail1_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
