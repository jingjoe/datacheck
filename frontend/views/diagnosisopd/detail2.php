...
$this->title = 'ตรวจรหัสวินิจฉัย ICD-10 PDx ไม่ตรงตามรหัสมาตรฐานรายบุคคล';
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title"><?= Html::encode($this->title) ?> ข้อมูล ณ.วันที่ <?= $date_start ?> ถึง <?= $date_end ?></h3>
                <h6><p><font color="red">เงื่อนไขการตรวจสอบแฟ้ม DIAGNOSIS_OPD รหัสวินิจฉัยโรคไม่ตรงตามรหัสมาตรฐาน ไม่มีใน ICD10(WHO 2010) หรือ (ICD10-TM 2012) ของ สนย.StandardCode43_v2.2 ICD10-TM 2016 </font>
...
<div class="box-body no-padding">
   <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Diagnosisopd_Detail2_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Diagnosisopd_Detail2_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Diagnosisopd_Detail2_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Diagnosisopd_Detail2_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
