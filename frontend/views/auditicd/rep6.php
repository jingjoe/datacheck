...
$this->title = 'ตรวจสอบการให้รหัส V00-Y34 ต้องให้รหัสรวม 5 ตัวอักษรเสมอ';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบ การให้รหัส V00-Y34 ต้องให้รหัสรวม 5 ตัวอักษรเสมอ </font></p></h6>
    ...
    <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'Auditicd10_Detail6_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'Auditicd10_Detail6_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'Auditicd10_Detail6_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Auditicd10_Detail6_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['auditicd/rep6'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => Yii::t('app', 'รีเซ็ต')])
                ],
                '{toggleData}',
                '{export}',
            ],
