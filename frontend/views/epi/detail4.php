...
$this->title = 'ตรวจสอบข้อมูลการให้บริการวัคซีน ER ไม่สมบูรณ์ เป็นรายบุคคล';
...
<br>
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><?= $this->title; ?> ข้อมูล ณ.วันที่  <?= $date_start ?> ถึง <?= $date_end ?></h3>
                    <h6><p><font color="red">ไม่ระบุวัคซีนที่ฉีด และ รัหสวัคซีนไม่ตรงตามมาตรฐาน [AND (pv.baby_code='' OR pv.baby_code IS NULL
    ...
    <div class="box-tools pull-right">
        <div class="btn-group">
            <?= Html::a('แฟ้ม EPI', ['/help/epi4'], ['class'=>'btn  btn-success btn-flat']) ?>
            <?= Html::a('การบันทึกข้อมูล', ['/help/epikey4'], ['class'=>'btn  btn-warning btn-flat']) ?>
        </div>
...
<br><br>         
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Epi_Detail4_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Epi_Detail4_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Epi_Detail4_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Epi_Detail4_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
