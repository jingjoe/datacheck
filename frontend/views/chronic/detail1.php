...
$this->title = 'ตรวจสอบข้อมูลผู้ป่วยโรคเรื้อรัง CHRONIC เป็นรายบุคคล';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">การบันทึกทะเบียนโรคเรื้อรัง ผู้ป่วยที่มีโรคเรื้อรัง 1 โรค จะมี 1 record หากมีมากกว่า 1 โรค ก็จะมีมากกว่า 1 record สำรวจปีละ 1 ครั้ง ภายในเดือนสิงหาคม และปรับฐานข้อมูลให้แล้วเสร็จภายในวันที่ 1 ตุลาคม ของทุกปี</font></p></h6>
    ...
    <div class="box-body no-padding">
     <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Chronic_Detail1_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Chronic_Detail1_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Chronic_Detail1_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Chronic_Detail1_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
