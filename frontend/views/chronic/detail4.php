...
$this->title = 'ตรวจสอบสถานนะผู้ป่วย 03=ยังรักษาอยู่, 05=รอจำหน่าย/เฝ้าระวัง';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบ ตรวจสอบสถานนะผู้ป่วย 03=ยังรักษาอยู่, 05=รอจำหน่าย/เฝ้าระวัง ไม่ต้องจำหน่วยผู้ป่วยออกจากทะเบียนและห้ามระบุวันที่จำหน่าย </font></p></h6>
    ...
    <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Chronic_Detail4_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Chronic_Detail4_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Chronic_Detail4_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Chronic_Detail4_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
