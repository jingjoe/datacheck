...
$this->title = 'รายงานอันดับโรคผู้ป่วย IPD ตามรหัสโรค ICD-10';
...
<div class="panel panel-default">
    <div class="panel-heading"> <h3 class="panel-title"><span class="glyphicon glyphicon glyphicon-signal"></span> รายงาน <?=$se ?> อันดับโรคผู้ป่วย IPD ตามรหัสโรค ICD-10 ข้อมูลวันที่ <?=$date1 ?> ถึง <?=$date2 ?></h3> </div>
    <div class="panel-body">
        ...
        $this->registerJs(" $(function () {
                            $('#container-line').highcharts({
                                ...
                                title: {
                                    text: 'รายงานอันดับโรคผู้ป่วย IPD ตามรหัสโรค ICD-10',
                                    x: -20 //center
                                },
                                subtitle: {
                                    text: '',
...
<br><br> 
     <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'ReportStats4_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'ReportStats4_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'ReportStats4_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'ReportStats4_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['rep4'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => Yii::t('app', 'รีเซ็ต')])
                ],
                '{toggleData}',
                '{export}',
            ],
