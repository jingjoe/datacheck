...
$this->title = 'ตรวจสอบข้อมูลผู้ป่วยคลอดปกติในทะเบียนคลอด แต่ไม่บันทึกข้อมูลคลอดหน้าแสดงข้อมูล Admit เป็นรายบุคคล';
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><?= $this->title; ?> ข้อมูล ณ.วันที่ <?= $date_start ?> ถึง <?= $date_end ?></h3>
                    <h6><p><font color="red">ตรวจสอบข้อมูลผู้ป่วยคลอดปกติในทะเบียนคลอด แต่ไม่บันทึกข้อมูลคลอดหน้าแสดงข้อมูล Admitเป็นรายบุคคล (ผู้ป่วยใน>ทะเบียนผู้ป่วยคลอด>หน้าแสดงข้อมูล Admit)</font></p></h6>
...
<div class="box-body no-padding">
   <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Labor_Detail3_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Labor_Detail3_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Labor_Detail3_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Labor_Detail3_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
