...
$this->title = 'ตรวจสอบข้อมูล 43 แฟ้ม : แฟ้ม DIAGNOSIS_IPD';
$this->params['breadcrumbs'][] = 'แฟ้ม DIAGNOSIS_IPD';
?>
<br>
...
<!-- MAP & BOX PANE -->
    <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">ตรวจสอบข้อมูลแฟ้ม DIAGNOSIS_IPD ข้อมูล ณ.วันที่ <?= $date_start ?> ถึง <?= $date_end ?></h3>
            ...
            <!-- row1 -->
                ...
                <div class="col-md-4" style="text-align: center;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9">
                            <?= Html::a('ดูรายละเอียด', ['/diagnosisipd/detail1'], ['class' => 'badge bg-purple']) ?>                      
                        </div>
                    </div>
                </div>
