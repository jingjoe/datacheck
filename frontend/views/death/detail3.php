...
$this->title = 'ตรวจสอบข้อมูลสาเหตุการตายที่ไม่ทราบสาเหตุ จากทะเบียนผู้เสียชีวิต(PERSON)เป็นรายบุคคล';
...
<br><br>         
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'beforeHeader'=>[
                [
                    'columns'=>[
                        ...
                        ['content'=>'จากทะเบียนเสียชีวิต บัญชี 1 โปรแกรม HOSxP', 'options'=>['colspan'=>8, 'class'=>'text-center warning']], 
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Death_Detail3_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Death_Detail3_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Death_Detail3_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Death_Detail3_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
