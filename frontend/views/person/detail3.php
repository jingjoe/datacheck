...
$this->title = 'ตรวจสอบเลข 13 หลักไม่ถูกต้องทั้งหมด เป็นรายบุคคล';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบเลข 13 หลักไม่ถูกต้องทั้งหมด (WHERE LEFT(cid, 1) NOT IN('1','2','3','4','5','6','7','8') OR LENGTH(cid)!='13' OR (cid='' OR cid IS NULL) OR cid LIKE '11111%' AND person_discharge_id='9' AND death<>'Y' ) </font></p></h6>
    ...
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Person_Detail3_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Person_Detail3_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Person_Detail3_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Person_Detail3_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
