...
$this->title = 'ตรวจสอบทะเบียนผู้ป่วย PERSON ที่เลข 13 หลักซ้ำซ้อนมากกว่า 1 CID รายบุคคลทั้งหมด';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบตรวจสอบทะเบียนผู้ป่วย PERSON ที่เลข 13 หลักซ้ำซ้อนมากกว่า 1 CID(select count(person_id),cid from person group by cid having count(person_id)>1)</font></p></h6>
 ...
 <div class="box-tools pull-right">
    ...
    <div class="box-body no-padding">
      <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Person_Detail6_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Person_Detail6_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Person_Detail6_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Person_Detail6_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
