...
$this->title = 'ตรวจสอบข้อมูลทั่วไปในบัญชี 1 PERSON เป็นรายบุคคล';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจข้อมูลทั่วไปในบัญชี 1 PERSON (ไม่ระบุคำนำหน้า,ชื่อ,นามสกุล,วันเดือนปีเกิด,เพศ,หมู่เลือด,อาชีพ,เชื่อสัญชาติ,เชื้อชาติ,ศาสนา,ระดับการศึกษา และ สถานะสมรส) </font></p></h6>
    ...
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Person_Detail4_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Person_Detail4_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Person_Detail4_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Person_Detail4_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
