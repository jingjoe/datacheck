...
$this->title = 'ตรวจสอบตรวจสอบข้อมูลแฟ้ม PROCEDURE_OPD รหัส ICD-9-CM ไม่ตรงมาตรฐาน';
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><?= Html::encode($this->title) ?> ข้อมูล ณ.วันที่ <?= $date_start ?> ถึง <?= $date_end ?></h3>
                    <h6><p><font color="red">เงื่อนไขการตรวจสอบแฟ้ม PROCEDCODE_OPD ,ใช้ตาราง Lookup ชื่อตาราง l_icd9tm ตรวจสอบรหัสหถการที่ไม่ถูกต้อง(อ้างอิงไฟล์ StandardCode43_(v2.2)_6Dec16 สนย.) </font>
...
<br><br> 
    <div class="box-body no-padding">
        <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Procedureopd_Detail1_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Procedureopd_Detail1_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Procedureopd_Detail1_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Procedureopd_Detail1_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
