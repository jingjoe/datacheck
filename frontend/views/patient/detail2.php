...
$this->title = 'ตรวจสอบเลข 13 หลักไม่ถูกต้อง(คนไทย ตามช่วงเวลาที่มารับบริการ) เป็นรายบุคคล';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบคนไทย เลข 13 หลักไม่ถูกต้อง( p.nationality='99' AND LEFT(p.cid,1) NOT IN('1','2','3','4','5','6','7','8'))</font></p></h6>
    ...
    <div class="box-body no-padding">
      <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Patient_Detail2_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Patient_Detail2_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Patient_Detail2_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Patient_Detail2_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
