...
$this->title = 'ตรวจสอบทะเบียนผู้ป่วย มีอายุมากกว่า 100 ปี เป็นรายบุคคลทั้งหมด';
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h6><p><font color="red">เงื่อนไขการตรวจสอบทะเบียนผู้ป่วย PATIENT มีอายุมากกว่า 100 ปี(WHERE floor(datediff(curdate(),birthday)/365) >='100')</font></p></h6>
   ...
   <div class="box-tools pull-right">
    ...
    <div class="box-body no-padding">
      <?=GridView::widget([
            ...
            'hover' => true,
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'F43_Patient_Detail4_'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'F43_Patient_Detail4_'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'F43_Patient_Detail4_'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'F43_Patient_Detail4_'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
